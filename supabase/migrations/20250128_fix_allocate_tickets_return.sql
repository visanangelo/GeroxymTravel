-- Fix ambiguous column reference in allocate_tickets function RETURN QUERY
-- This fixes the "column reference seat_no is ambiguous" error in the RETURN QUERY statement
...
BEGIN
  ...
  -- Insert tickets (using alias to avoid ambiguity)

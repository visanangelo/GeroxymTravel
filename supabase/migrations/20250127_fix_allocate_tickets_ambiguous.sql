-- Fix ambiguous column reference in allocate_tickets function
-- Run this after the initial migration if you get "column reference seat_no is ambiguous" error
